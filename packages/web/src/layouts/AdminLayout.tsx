...
const AdminLayout = () => (
  <section className="flex flex-col gap-5 px-4 py-8 sm:px-6 lg:px-14">
    <div className="flex max-w-[920px] flex-col gap-3">
      <span className="inline-block text-[0.74rem] uppercase tracking-[0.16em] text-[#d71920]">Admin Area</span>
      <h1 className="[font-family:Bahnschrift,'Arial_Narrow',sans-serif] text-[clamp(2rem,4vw,3.4rem)] font-extrabold leading-[0.96] text-[#111]">
        Control center for the e-bike storefront and backend operations.
      </h1>
      <p className="m-0 leading-[1.7] text-[#6a6a6a]">
        Use this route group to separate admin tasks from guest and customer features while the team develops in
        parallel.
      </p>
    </div>
